...
import com.home.back.bottom.util.IInAppBillingService;
...
public class IabHelper {
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            logError("Successful resultcode from purchase activity.");
            logError("Purchase data: " + purchaseData);
            logError("Data signature: " + dataSignature);
            logError("Extras: " + data.getExtras());
            logError("Expected item type: " + mPurchasingItemType);

            if (purchaseData == null || dataSignature == null) {
                logError("BUG: either purchaseData or dataSignature is null.");
                logError("Extras: " + data.getExtras().toString());
            ...
            try {
                ...
                logError("Purchase signature successfully verified.");
